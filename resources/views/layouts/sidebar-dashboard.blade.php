    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                @can('isAdmin')
                    <li>
                        <a class="waves-effect waves-dark" href="{{ url('dashboard/admin/admin-panel') }}"
                            aria-expanded="false">
                    ...
                    <li>
                        <a class="waves-effect waves-dark" href="{{ url('dashboard/admin/view-panel') }}"
                            aria-expanded="false">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                            <span class="hide-menu">View Panel</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect waves-dark" href="{{ url('dashboard/admin/users') }}" aria-expanded="false">
                            <i class="fa fa-users" aria-hidden="true"></i>
                            <span class="hide-menu">Users</span>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect waves-dark" href="{{ url('dashboard/admin/subscribe') }}"
                            aria-expanded="false">
                    ...
                    <li>
                        <a class="waves-effect waves-dark" href="{{ url('dashboard/admin/payment') }}"
                            aria-expanded="false">
                            <div class="d-flex" style="gap: 20px">
                                <i class="fa fa-money" aria-hidden="true"></i>
                                <span class="hide-menu">payment <br> <small>(Berbayar dari Payment Gateway)</small></span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="waves-effect waves-dark" disabled aria-expanded="false">
                            <div class="d-flex" style="gap: 20px">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25"
                                    height="25" viewBox="0,0,256,256" style="fill:#000000;">
                                    <g fill-opacity="0.4902" fill="#000000" fill-rule="nonzero" stroke="none"
                                ...
                                <span class="hide-menu">Broadcast WA <br> <small>(Berbayar dari WA)</small></span>
                            </div>
                        </a>
                    </li>
                @endcan
                ...
                <li>
                    <a class="waves-effect waves-dark" href="{{ url('dashboard/profile') }}" aria-expanded="false">
                ...
                <li>
                    <form action="{{ url('logout') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="waves-effect waves-dark text-light mt-5"
